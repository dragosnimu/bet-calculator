...
o alertă pe Telegram când o acțiune scade cu **≥3% față de închiderea de ieri**. Re-alertează la
fiecare treaptă suplimentară (−3%, −6%, −9%…), cu resetare automată la începutul fiecărei zile.
...
| `ALERT_DROP_STEP`     | `3`               | Pragul de scădere, în %                      |
